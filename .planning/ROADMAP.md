...
**Plans**: 4 plans
- [ ] 09-01-PLAN.md — CI 2-job split: `tests` ‖ `image-downstream`, seed `make grep-no-compose` static-check (c) — SC-5, SC-1 [Wave 1]
- [ ] 09-02-PLAN.md — RED-first regression tests for SC-6 bug classes + relative-bind-mount e2e fixture (TDD per C4) — SC-6, SC-2 [Wave 2]
...
| 9. Architectural Hardening (post-v0.1 bug-cluster) | 0/4 | Not started | - |
